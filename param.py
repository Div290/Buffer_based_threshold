...
sst_train_path = r"path to sst train data"
sst_test_path = r"path to sst test data"
snli_train_path = r"path to snli train data"
snli_test_path = r"path to snli test data"

dataframe_save_path = r"C:\Users\divya\Downloads\evaluation_res_imdb (1).csv"


# Simulation Parameters
arrival_rate = 5  # Poisson arrival rate (λ)
